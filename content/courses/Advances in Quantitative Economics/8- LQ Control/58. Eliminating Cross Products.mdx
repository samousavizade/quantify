...
is defined by a 4-tuple of matrices: $ (A^_, B, R^_, Q) $.
...
The matrices $ (A^_, B, R^_, Q) $ defining the equivalent problem and the value function, policy function matrices $ P, F^\* $ that solve it are related to the matrices $ (A, B, R, Q, H) $ defining the original problem and the value function, policy function matrices $ P, F $ that solve the original problem by
