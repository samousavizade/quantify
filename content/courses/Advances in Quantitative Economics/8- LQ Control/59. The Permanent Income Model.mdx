...
- $ z*t $ is an \_exogenous* component, unaffected by consumer behavior.
- $ b*t $ is an \_endogenous* component (since it depends on the decision rule).
...
Nevertheless, there is a linear combination of $ c*t, b_t $ that \_is* asymptotically stationary.
