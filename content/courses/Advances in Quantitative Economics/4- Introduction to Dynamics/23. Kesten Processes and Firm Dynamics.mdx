...
Given the definition of stationarity and our assumption that $ F^_ $ is stationary for the wealth process, this equals $ F^_(y) $.
...
More precisely, if $ F^_ $ is the unique stationary distribution and $ X^_ \sim F^\* $, then:
