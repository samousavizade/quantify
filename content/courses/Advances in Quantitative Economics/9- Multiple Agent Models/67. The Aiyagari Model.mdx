...
In this lecture, we describe the structure of a class of models that build on work by Truman Bewley [[Bewley, 1977](/courses/Introduction-to-Quantitative-Economics/References#id177)].

We begin by discussing an example of a Bewley model due to Rao Aiyagari [[Aiyagari, 1994](/courses/Introduction-to-Quantitative-Economics/References#id141)].
...
- precautionary savings and the effect of liquidity constraints [[Aiyagari, 1994](/courses/Introduction-to-Quantitative-Economics/References#id141)]
- risk sharing and asset pricing [[Heaton and Lucas, 1996](/courses/Introduction-to-Quantitative-Economics/References#id133)]
- the shape of the wealth distribution [[Benhabib _et al._, 2015](/courses/Introduction-to-Quantitative-Economics/References#id134)]
- etc., etc., etc.
...
The primary reference for this lecture is [[Aiyagari, 1994](/courses/Introduction-to-Quantitative-Economics/References#id141)].

A textbook treatment is available in chapter 18 of [[Ljungqvist and Sargent, 2018](/courses/Introduction-to-Quantitative-Economics/References#id186)].
...
A unit interval of _ex-ante_ identical households face a common borrowing constraint.
...
$$
r = A \alpha  \left( \frac{N}{K} \right)^{1 - \alpha} - \delta \tag{67.1}
$$
...
$$
w(r) = A  (1 - \alpha)  (A \alpha / (r + \delta))^{\alpha / (1 - \alpha)} \tag{67.2}
$$

### Equilibrium

We construct a _stationary rational expectations equilibrium_ (SREE).
...
1. determine corresponding prices, with interest rate $ r $ determined by [(67.1)](#equation-aiy-rgk) and a wage rate $ w(r) $ as given in [(67.2)](#equation-aiy-wgr)
...
To solve the household’s dynamic programming problem we’ll use the **DiscreteDP** class from [QuantEcon.py](https://quantecon.org/quantecon-py/).
...
The action is the choice of next period asset level $ a\_{t+1} $.
...
>
  ![png](/static/courses/Advances%20in%20Quantitative%20Economics/67.%20The%20Aiyagari%20Model_files/67.%20The%20Aiyagari%20Model_15_0.png)
</div>
...
>
  ![png](/static/courses/Advances%20in%20Quantitative%20Economics/67.%20The%20Aiyagari%20Model_files/67.%20The%20Aiyagari%20Model_17_0.png)
</div>
