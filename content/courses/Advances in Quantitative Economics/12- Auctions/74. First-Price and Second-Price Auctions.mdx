...
- a Second-Price Sealed-Bid Auction (SPSB) created by William Vickrey [[Vickrey, 1961](/courses/Introduction-to-Quantitative-Economics/References#id25)]
...
$$
\mathbf{E}[y_{i} | y_{i} < v_{i}] \tag{74.1}
$$

where $ v*{i} $ is the valuation of bidder $ i $ and $ y*{i} $ is the maximum valuation of all other bidders:
...
We assume valuation $ v*{i} $ of bidder $ i $ is distributed $ v*{i} \stackrel{\text{i.i.d.}}{\sim} U(0,1) $.
...
An optimal bid for bidder $ i $ in a **FPSB** is described by equations [(74.1)](#equation-eq-optbid1) and [(74.2)](#equation-eq-optbid2).

When bids are i.i.d. draws from a uniform distribution, the CDF of $ y\_{i} $ is
...
and the PDF of $ y*i $ is $ \tilde{f}*{n-1}(y) = (n-1)y^{n-2} $.
...
Let’s now plot the _winning_ bids $ b*{(n)} $ (i.e. the payment) against valuations, $ v*{(n)} $ for both FPSB and SPSB.
...
>
  ![png](/static/courses/Advances%20in%20Quantitative%20Economics/74.%20First-Price%20and%20Second-Price%20Auctions_files/74.%20First-Price%20and%20Second-Price%20Auctions_16_0.png)
</div>
...
Above we computed that the CDF is $ F*{n}(y) = y^{n} $ and the PDF is $ f*{n} = ny^{n-1} $.
...
>
  ![png](/static/courses/Advances%20in%20Quantitative%20Economics/74.%20First-Price%20and%20Second-Price%20Auctions_files/74.%20First-Price%20and%20Second-Price%20Auctions_18_1.png)
</div>
...
| Bayesian Nash equilibrium | Bidder $ i $ bids $ \frac{n-1}{n}v\_{i} $ | Bidder $ i $ truthfully bids $ v\_{i} $ |
...
Let $ b(v\_{i}) $ be the optimal bid in a FPSB auction.

The revenue equivalence theorem tells us that a bidder agent with value $ v\_{i} $ on average receives the same **payment** in the two types of auction.
...
It follows that an optimal bidding strategy in a FPSB auction is $ b(v*{i}) = \mathbf{E}*{y*{i}}[y*{i} | y*{i} < v*{i}] $.

## Calculation of Bid Price in FPSB

In equations [(74.1)](#equation-eq-optbid1) and [(74.1)](#equation-eq-optbid1), we displayed formulas for
...
- $ v\_{i} = $ value of bidder $ i $
- $ y*{i} = $: maximum value of all bidders except $ i $, i.e., $ y*{i} = \max*{j \neq i} v*{j} $
...
>
  ![png](/static/courses/Advances%20in%20Quantitative%20Economics/74.%20First-Price%20and%20Second-Price%20Auctions_files/74.%20First-Price%20and%20Second-Price%20Auctions_23_0.png)
</div>
...
>
  ![png](/static/courses/Advances%20in%20Quantitative%20Economics/74.%20First-Price%20and%20Second-Price%20Auctions_files/74.%20First-Price%20and%20Second-Price%20Auctions_25_0.png)
</div>
...
```
    ...
    /var/folders/zj/sz5g50055l9gj8nhh_6md1cw0000gn/T/ipykernel_39690/521884726.py:25: RuntimeWarning: Mean of empty slice.
      return array_conditional[-order,:].mean()
    /Users/s.alirezamousavizade/anaconda3/lib/python3.11/site-packages/numpy/core/_methods.py:129: RuntimeWarning: invalid value encountered in scalar divide
...
>
  ![png](/static/courses/Advances%20in%20Quantitative%20Economics/74.%20First-Price%20and%20Second-Price%20Auctions_files/74.%20First-Price%20and%20Second-Price%20Auctions_30_0.png)
</div>
...
>
  ![png](/static/courses/Advances%20in%20Quantitative%20Economics/74.%20First-Price%20and%20Second-Price%20Auctions_files/74.%20First-Price%20and%20Second-Price%20Auctions_33_1.png)
</div>
...
>
  ![png](/static/courses/Advances%20in%20Quantitative%20Economics/74.%20First-Price%20and%20Second-Price%20Auctions_files/74.%20First-Price%20and%20Second-Price%20Auctions_37_0.png)
</div>
...
```
    ...
    /var/folders/zj/sz5g50055l9gj8nhh_6md1cw0000gn/T/ipykernel_39690/919518230.py:37: RuntimeWarning: Mean of empty slice.
      return array_conditional[-order,:].mean()
    /Users/s.alirezamousavizade/anaconda3/lib/python3.11/site-packages/numpy/core/_methods.py:129: RuntimeWarning: invalid value encountered in scalar divide
      ret = ret.dtype.type(ret / rcount)
...
>
  ![png](/static/courses/Advances%20in%20Quantitative%20Economics/74.%20First-Price%20and%20Second-Price%20Auctions_files/74.%20First-Price%20and%20Second-Price%20Auctions_38_1.png)
</div>
...
>
  ![png](/static/courses/Advances%20in%20Quantitative%20Economics/74.%20First-Price%20and%20Second-Price%20Auctions_files/74.%20First-Price%20and%20Second-Price%20Auctions_39_1.png)
</div>
