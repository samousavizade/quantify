...
Let $ w(X*t, p_S) $ represent the option's value when the time $ t $ growth state is known to be $ X_t $, but \_before* the owner decides whether to exercise the option
at time $ t $ (i.e., today).
