...
So let’s suppose instead that we obtain a sample $ w_1, w_2, \cdots, w_n $ telling us the wealth of $ n $ randomly
...
plt.stairs(prob, edges, fill=True, alpha=0.8, label=r"unit: $100,000 dollars$")
plt.ylabel("prob")
...
![png](/static/courses/Introduction-to-Quantitative-Economics/mle_files/mle_10_0.png)
...
![png](/static/courses/Introduction-to-Quantitative-Economics/mle_files/mle_15_0.png)
...
For our sample $ w_1, w_2, \cdots, w_n $, the [likelihood function](https://en.wikipedia.org/wiki/Likelihood_function)
is given by
...
To find where this function is maximised we find its partial derivatives wrt $ \mu $ and $ \sigma ^2 $ and equate them
to $ 0 $.
...
![png](/static/courses/Introduction-to-Quantitative-Economics/mle_files/mle_20_0.png)

Our estimated lognormal distribution appears to be a reasonable fit for the overall data.

We now use [(45.1)](#equation-eq-est-rev) to calculate total revenue.
...
![png](/static/courses/Introduction-to-Quantitative-Economics/mle_files/mle_33_0.png)
...
![png](/static/courses/Introduction-to-Quantitative-Economics/mle_files/mle_38_0.png)
...
![png](/static/courses/Introduction-to-Quantitative-Economics/mle_files/mle_41_0.png)
...
![png](/static/courses/Introduction-to-Quantitative-Economics/mle_files/mle_44_0.png)
...
There are other more rigorous tests, such as
...
![png](/static/courses/Introduction-to-Quantitative-Economics/mle_files/mle_54_0.png)
