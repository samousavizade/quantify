...
![png](/static/courses/Introduction-to-Quantitative-Economics/lln_clt_files/lln_clt_21_0.png)
...
![png](/static/courses/Introduction-to-Quantitative-Economics/lln_clt_files/lln_clt_25_0.png)
...
![png](/static/courses/Introduction-to-Quantitative-Economics/lln_clt_files/lln_clt_27_0.png)
...
> **Note**Although in this case the violation of IID breaks the LLN, there _are_ situations
...
![png](/static/courses/Introduction-to-Quantitative-Economics/lln_clt_files/lln_clt_37_0.png)
...
![png](/static/courses/Introduction-to-Quantitative-Economics/lln_clt_files/lln_clt_42_0.png)
...
(since $ X\_{t+1} $ depends on the value of $ X_t $).
...
Now we claim it is also true for $ X\_{t+1} $.
...
![png](/static/courses/Introduction-to-Quantitative-Economics/lln_clt_files/lln_clt_49_0.png)
