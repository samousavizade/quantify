...
```
    ...
    CPU times: user 1.92 s, sys: 20.7 ms, total: 1.94 s
    Wall time: 1.93 s
...
```
    ...
    CPU times: user 54.7 ms, sys: 7.5 ms, total: 62.2 ms
    Wall time: 68.9 ms
...
```
    ...
    CPU times: user 512 ms, sys: 75.9 ms, total: 588 ms
    Wall time: 674 ms
...
![png](/static/courses/Introduction-to-Quantitative-Economics/monte_carlo_files/monte_carlo_40_0.png)
...
```
    ...
    CPU times: user 316 ms, sys: 4.16 ms, total: 320 ms
    Wall time: 111 ms
...
```
    ...
    CPU times: user 13.2 ms, sys: 1.9 ms, total: 15.1 ms
    Wall time: 5.06 ms
...
```
    ...
    CPU times: user 1min 39s, sys: 591 ms, total: 1min 40s
    Wall time: 1min 40s
...
Use the dynamics defined in [(20.1)](#equation-s-mc-dyms) to price the European call option.
...
```
    ...
    CPU times: user 614 ms, sys: 7.38 ms, total: 622 ms
    Wall time: 719 ms
...
```
    ...
    CPU times: user 20.5 ms, sys: 2.23 ms, total: 22.8 ms
    Wall time: 22.4 ms
