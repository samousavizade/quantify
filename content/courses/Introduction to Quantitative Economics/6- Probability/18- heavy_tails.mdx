...
![png](/static/courses/Introduction-to-Quantitative-Economics/heavy_tails_files/heavy_tails_8_0.png)
...
```
    ...
    (-5.044114812786016, 5.016380413875083)
...
![png](/static/courses/Introduction-to-Quantitative-Economics/heavy_tails_files/heavy_tails_12_0.png)
...
![png](/static/courses/Introduction-to-Quantitative-Economics/heavy_tails_files/heavy_tails_17_0.png)
...
![png](/static/courses/Introduction-to-Quantitative-Economics/heavy_tails_files/heavy_tails_20_0.png)
...
![png](/static/courses/Introduction-to-Quantitative-Economics/heavy_tails_files/heavy_tails_22_0.png)

If we look at higher frequency returns data (e.g., tick-by-tick), we often see
even more extreme observations.

See, for example, [[Mandelbrot, 1963](/courses/Introduction-to-Quantitative-Economics/References#id86)] or [[Rachev, 2003](/courses/Introduction-to-Quantitative-Economics/References#id85)].
...
![png](/static/courses/Introduction-to-Quantitative-Economics/heavy_tails_files/heavy_tails_29_0.png)
...
![png](/static/courses/Introduction-to-Quantitative-Economics/heavy_tails_files/heavy_tails_32_0.png)
...
![png](/static/courses/Introduction-to-Quantitative-Economics/heavy_tails_files/heavy_tails_34_0.png)
...
![png](/static/courses/Introduction-to-Quantitative-Economics/heavy_tails_files/heavy_tails_39_0.png)
...
![png](/static/courses/Introduction-to-Quantitative-Economics/heavy_tails_files/heavy_tails_41_0.png)
...
![png](/static/courses/Introduction-to-Quantitative-Economics/heavy_tails_files/heavy_tails_46_0.png)
...
![png](/static/courses/Introduction-to-Quantitative-Economics/heavy_tails_files/heavy_tails_49_0.png)
...
![png](/static/courses/Introduction-to-Quantitative-Economics/heavy_tails_files/heavy_tails_51_0.png)
...
![png](/static/courses/Introduction-to-Quantitative-Economics/heavy_tails_files/heavy_tails_57_0.png)
...
![png](/static/courses/Introduction-to-Quantitative-Economics/heavy_tails_files/heavy_tails_59_0.png)
...
![png](/static/courses/Introduction-to-Quantitative-Economics/heavy_tails_files/heavy_tails_61_0.png)
...
![png](/static/courses/Introduction-to-Quantitative-Economics/heavy_tails_files/heavy_tails_64_0.png)
...
To understand this point better, recall our earlier discussion
of the law of large numbers, which considered IID $ X_1, \ldots, X_n $ with common distribution $ F $

If $ \mathbb E |X*i| $ is finite, then
the sample mean $ \bar X_n := \frac{1}{n} \sum*{i=1}^n X_i $ satisfies
...
![png](/static/courses/Introduction-to-Quantitative-Economics/heavy_tails_files/heavy_tails_67_0.png)
...
A distribution $ F $ with density $ f $ on $ \mathbb R\_+ $ is called [heavy-tailed](https://en.wikipedia.org/wiki/Heavy-tailed_distribution) if

$$
\int_0^\infty \exp(tx) f(x) dx = \infty \; \text{ for all } t > 0. \tag{21.4}
$$
...
For more on heavy tails in the wealth distribution, see e.g., [[Vilfredo, 1896](/courses/Introduction-to-Quantitative-Economics/References#id90)] and [[Benhabib and Bisin, 2018](/courses/Introduction-to-Quantitative-Economics/References#id89)].

For more on heavy tails in the firm size distribution, see e.g., [[Axtell, 2001](/courses/Introduction-to-Quantitative-Economics/References#id88)], [[Gabaix, 2016](/courses/Introduction-to-Quantitative-Economics/References#id87)].

For more on heavy tails in the city size distribution, see e.g., [[Rozenfeld _et al._, 2011](/courses/Introduction-to-Quantitative-Economics/References#id84)], [[Gabaix, 2016](/courses/Introduction-to-Quantitative-Economics/References#id87)].
...
For further reading, see, for example, [[Acemoglu and Robinson, 2002](/courses/Introduction-to-Quantitative-Economics/References#id83)], [[Glaeser _et al._, 2003](/courses/Introduction-to-Quantitative-Economics/References#id82)], [[Bhandari _et al._, 2018](/courses/Introduction-to-Quantitative-Economics/References#id81)] or [[Ahn _et al._, 2018](/courses/Introduction-to-Quantitative-Economics/References#id80)].
...
In view of [(21.2)](#equation-plrt), we can take positive constants $ b $ and $ \bar x $ such that
...
We know that $ \int\_{\bar x}^\infty x^{r-\alpha-1} dx = \infty $ whenever $ r - \alpha - 1 \geq -1 $.
...
![png](/static/courses/Introduction-to-Quantitative-Economics/heavy_tails_files/heavy_tails_80_0.png)
...
[[Fujiwara _et al._, 2004](/courses/Introduction-to-Quantitative-Economics/References#id73)], [[Kondo _et al._, 2018](/courses/Introduction-to-Quantitative-Economics/References#id71)] or [[Schluter and Trede, 2019](/courses/Introduction-to-Quantitative-Economics/References#id72)]).
...
The Pareto distribution is assumed to take the form [(21.1)](#equation-pareto) with $ \bar x = 1 $ and $ \alpha = 1.05 $.

(The value of the tail index $ \alpha $ is plausible given the data [[Gabaix, 2016](/courses/Introduction-to-Quantitative-Economics/References#id87)].)
...
The mean and median of the Pareto distribution [(21.1)](#equation-pareto) with
$ \bar x = 1 $ are
...
![png](/static/courses/Introduction-to-Quantitative-Economics/heavy_tails_files/heavy_tails_89_0.png)
...
In view of [(21.5)](#equation-lln-cch), this is just $ e^{-|t|} $.
