...
because it shows the fundamental importance of _expectations_.
...
Early papers on the cobweb cycle include [[Waugh, 1964](/courses/Introduction-to-Quantitative-Economics/References#id279)] and [[Harlow, 1960](/courses/Introduction-to-Quantitative-Economics/References#id280)].

The paper [[Harlow, 1960](/courses/Introduction-to-Quantitative-Economics/References#id280)] uses the cobweb theorem to explain the prices of hog in the US over 1920–1950.
...
![png](/static/courses/Introduction-to-Quantitative-Economics/cobweb_files/cobweb_5_0.png)
...
Because the crop of soybeans for time $ t $ is planted at $ t-1 $, supply of soybeans at time $ t $ depends on _expected_ prices at time $ t $, which we denote $ p^e_t $.
...
![png](/static/courses/Introduction-to-Quantitative-Economics/cobweb_files/cobweb_9_0.png)
...
![png](/static/courses/Introduction-to-Quantitative-Economics/cobweb_files/cobweb_17_0.png)
...
Since $ p*{t+1} = g(p_t) $, we use the graph of $ g $ to see $ p*{t+1} $ on the vertical axis.

Clearly,

- If $ g $ lies above the 45-degree line at $ p*t $, then we have $ p*{t+1} > p_t $.
- If $ g $ lies below the 45-degree line at $ p*t $, then we have $ p*{t+1} < p_t $.
- If $ g $ hits the 45-degree line at $ p*t $, then we have $ p*{t+1} = p_t $, so $ p_t $ is a steady state.
...
![png](/static/courses/Introduction-to-Quantitative-Economics/cobweb_files/cobweb_20_0.png)
...
![png](/static/courses/Introduction-to-Quantitative-Economics/cobweb_files/cobweb_22_0.png)
...
![png](/static/courses/Introduction-to-Quantitative-Economics/cobweb_files/cobweb_28_0.png)
...
![png](/static/courses/Introduction-to-Quantitative-Economics/cobweb_files/cobweb_34_0.png)
...
![png](/static/courses/Introduction-to-Quantitative-Economics/cobweb_files/cobweb_39_0.png)
