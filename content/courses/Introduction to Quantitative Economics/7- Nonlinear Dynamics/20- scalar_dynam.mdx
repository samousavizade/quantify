...
Letting $ \pi*t $ be inflation this year and $ \pi*{t-1} $ be inflation last year, we
...
- first order means dependence on only one lag (i.e., earlier states such as $ x\_{t-1} $ do not enter into [(23.1)](#equation-sdsod)).
...
point $ \hat{x} $ in $ S $ such that $ \hat{x} = g(x^\*) $.

In other words, $ x^\* $ is a **fixed point** of the function $ g $ in
$ S $.

For example, for the linear model $ x\_{t+1} = a x_t + b $, you can use the
...
For example, in the linear model $ x\_{t+1} = a x_t + b $ with $ a
...
![png](/static/courses/Introduction-to-Quantitative-Economics/scalar_dynam_files/scalar_dynam_19_0.png)

The plot shows the function $ g $ and the 45-degree line.

Think of $ k_t $ as a value on the horizontal axis.

To calculate $ k\_{t+1} $, we can use the graph of $ g $ to see its
value on the vertical axis.

Clearly,

- If $ g $ lies above the 45-degree line at this point, then we have $ k\_{t+1} > k_t $.
- If $ g $ lies below the 45-degree line at this point, then we have $ k\_{t+1} < k_t $.
- If $ g $ hits the 45-degree line at this point, then we have $ k\_{t+1} = k_t $, so $ k_t $ is a steady state.

For the Solow-Swan model, there are two steady states when $ S = \mathbb R\_+ =
[0, \infty) $.
...
![png](/static/courses/Introduction-to-Quantitative-Economics/scalar_dynam_files/scalar_dynam_22_0.png)
...
![png](/static/courses/Introduction-to-Quantitative-Economics/scalar_dynam_files/scalar_dynam_24_0.png)
...
![png](/static/courses/Introduction-to-Quantitative-Economics/scalar_dynam_files/scalar_dynam_26_0.png)
...
![png](/static/courses/Introduction-to-Quantitative-Economics/scalar_dynam_files/scalar_dynam_28_0.png)
...
![png](/static/courses/Introduction-to-Quantitative-Economics/scalar_dynam_files/scalar_dynam_30_0.png)
...
![png](/static/courses/Introduction-to-Quantitative-Economics/scalar_dynam_files/scalar_dynam_32_0.png)
...
![png](/static/courses/Introduction-to-Quantitative-Economics/scalar_dynam_files/scalar_dynam_34_0.png)
...
![png](/static/courses/Introduction-to-Quantitative-Economics/scalar_dynam_files/scalar_dynam_36_0.png)
...
![png](/static/courses/Introduction-to-Quantitative-Economics/scalar_dynam_files/scalar_dynam_38_0.png)

## Exercises

## Exercise 23.1

Consider again the linear model $ x\_{t+1} = a x_t + b $ with $ a
\not=1 $.
...
![png](/static/courses/Introduction-to-Quantitative-Economics/scalar_dynam_files/scalar_dynam_44_0.png)
...
![png](/static/courses/Introduction-to-Quantitative-Economics/scalar_dynam_files/scalar_dynam_46_0.png)
...
![png](/static/courses/Introduction-to-Quantitative-Economics/scalar_dynam_files/scalar_dynam_50_0.png)
...
![png](/static/courses/Introduction-to-Quantitative-Economics/scalar_dynam_files/scalar_dynam_52_0.png)
