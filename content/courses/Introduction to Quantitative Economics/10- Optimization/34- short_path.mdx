...
![png](https://intro.quantecon.org/_static/lecture_specific/short_path/graph.png)
...
![png](https://intro.quantecon.org/_static/lecture_specific/short_path/graph4.png)

- A, D, F, G at cost 8

![png](https://intro.quantecon.org/_static/lecture_specific/short_path/graph3.png)
...
![png](https://intro.quantecon.org/_static/lecture_specific/short_path/graph2.png)
...
1. Set $ n = 0 $
1. Set $ J*{n+1} (v) = \min*{w \in F_v} \{ c(v, w) + J_n(w) \} $ for all $ v $
1. If $ J\_{n+1} $ and $ J_n $ are not equal then increment $ n $, go to 2
