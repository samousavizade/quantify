...
Notice that both $ R*t = \frac{p_t}{p*{t+1}} $ and $ b*t = \frac{m*{t+1}}{p_t} $ are _ratios_.
...
the path of $ y^_\_t $, and therefore the paths of both $ m_t $ and $ p_t $ given by
$ y_t = Q y^__t $ will eventually grow at gross rates $ {R_\ell}^{-1} $ as
$ t \rightarrow +\infty $.
